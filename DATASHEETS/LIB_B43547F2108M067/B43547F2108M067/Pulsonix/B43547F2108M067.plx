...
(library Library_1
	...
	(compDef "B43547F2108M067" (originalName "B43547F2108M067") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attr "<Hyperlink>" "https://product.tdk.com/system/files/dam/doc/product/capacitor/aluminum-electrolytic/snap-in/data_sheet/20/30/db/aec/b43547.pdf")
		(attr "<Component Height>" "42")
		(attr "<STEP Filename>" "B43547F2108M067.stp")
