...
(library Library_1
	...
	(symbolDef "STPS20200CTN" (originalName "STPS20200CTN")
		...
		(pin (pinNum 2) (pt 700 mils 100 mils) (rotation 180) (pinLength 100 mils) (pinDisplay (dispPinName false)) (pinName (text (pt 560 mils 85 mils) (rotation 0]) (justify "Right") (textStyleRef "Default"))
		))
		(pin (pinNum 3) (pt 700 mils -100 mils) (rotation 180) (pinLength 100 mils) (pinDisplay (dispPinName false)) (pinName (text (pt 560 mils -115 mils) (rotation 0]) (justify "Right") (textStyleRef "Default"))
		))
	...
	(compDef "STPS20200CTN" (originalName "STPS20200CTN") (compHeader (numPins 3) (numParts 1) (refDesPrefix D)
		...
		(attr "Datasheet Link" "http://www.st.com/web/en/resource/technical/document/datasheet/DM00079941.pdf")
		(attr "Height" "4.6 mm")
	)
