...
//222460/1771792/2.50/3/4/Schottky Diode with Dual Anode
...
(library Library_1
	...
	(patternDef "TO255P460X1020X1905-3P" (originalName "TO255P460X1020X1905-3P")
		(multiLayer
	...
	(symbolDef "STPS20200CTN" (originalName "STPS20200CTN")
		...
		(pin (pinNum 2) (pt 700 mils 100 mils) (rotation 180) (pinLength 100 mils) (pinDisplay (dispPinName false)) (pinName (text (pt 560 mils 85 mils) (rotation 0]) (justify "Right") (textStyleRef "Normal"))
		))
		(pin (pinNum 3) (pt 700 mils -100 mils) (rotation 180) (pinLength 100 mils) (pinDisplay (dispPinName false)) (pinName (text (pt 560 mils -115 mils) (rotation 0]) (justify "Right") (textStyleRef "Normal"))
		))
	...
	(compDef "STPS20200CTN" (originalName "STPS20200CTN") (compHeader (numPins 3) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "STPS20200CTN"))
		(attachedPattern (patternNum 1) (patternName "TO255P460X1020X1905-3P")
			(numPads 3)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "STPS20200CTN")
		(attr "Mouser Part Number" "")
		(attr "Mouser Price/Stock" "")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "STMicroelectronics 200V 30A, Dual Diode, 3-Pin TO-220AB STPS20200CTN")
		(attr "<Hyperlink>" "http://www.st.com/web/en/resource/technical/document/datasheet/DM00079941.pdf")
		(attr "<Component Height>" "4.6")
		(attr "<STEP Filename>" "STPS20200CTN.stp")
